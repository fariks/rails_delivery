...
class LoadsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create load" do
    assert_difference('Load.count') do
      post loads_url, params: { load: { deliveryDate: @load.deliveryDate, deliveryShift: @load.deliveryShift, driver_id: @load.driver_id } }
    end
  ...
  test "should update load" do
    patch load_url(@load), params: { load: { deliveryDate: @load.deliveryDate, deliveryShift: @load.deliveryShift, driver_id: @load.driver_id } }
