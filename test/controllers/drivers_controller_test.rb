...
class DriversControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create driver" do
    assert_difference('Driver.count') do
      post drivers_url, params: { driver: { name: @driver.name, vehicle_id: @driver.vehicle_id } }
    end
  ...
  test "should update driver" do
    patch driver_url(@driver), params: { driver: { name: @driver.name, vehicle_id: @driver.vehicle_id } }
